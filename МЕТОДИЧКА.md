...
4. **Управление профилем**
   ...
   - Редактирование личных данных (ФИО, телефон, почта, город, адрес, компания)
   - Загрузка аватара
...
#### Таблица: profiles
Хранит профили пользователей с полной информацией
...
### Е.3 Создание базы данных с нуля

В проекте создан файл `database-setup.sql`, содержащий полный SQL скрипт для создания базы данных.
...
2. **Выполните SQL скрипт**
   ...
   - Скопируйте содержимое файла `database-setup.sql`
...
5. **Создайте первого администратора**
   ```sql
   -- Получите user_id после регистрации
...
**Что создает скрипт:**
- Все необходимые таблицы (profiles, products, cart_items, chat_sessions, chat_messages)
- Enum типы (app_role)
- RLS политики для всех таблиц
- Функции и триггеры
- Storage buckets для аватаров
- Настройки Realtime для чата

Полная документация находится внутри файла `database-setup.sql`.
